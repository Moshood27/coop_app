...
var legacyRegisterWebPlugin = (cap, webPlugin) => {
	...
	if (!(config === null || config === void 0 ? void 0 : config.name)) throw new Error(`Capacitor WebPlugin is using the deprecated "registerWebPlugin()" function, but without the config. Please use "registerPlugin()" instead to register this web plugin."`);
	console.warn(`Capacitor plugin "${config.name}" is using the deprecated "registerWebPlugin()" function`);
	if (!Plugins[config.name] || ((_a = config === null || config === void 0 ? void 0 : config.platforms) === null || _a === void 0 ? void 0 : _a.includes(cap.getPlatform()))) Plugins[config.name] = webPlugin;
};
var ExceptionCode;
