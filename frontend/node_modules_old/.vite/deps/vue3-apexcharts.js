import { $n as toRefs, At as onBeforeMount, Ft as onMounted, Kn as ref, Ot as nextTick, Rt as onServerPrefetch, Vt as openBlock, ar as normalizeClass, gn as watch, jt as onBeforeUnmount, nt as defineComponent, pt as h, q as createElementBlock, ut as getCurrentInstance } from "./vue.runtime.esm-bundler-CKUwx75R.js";
...
var C = [
	...
	setup(t) {
		...
		return onServerPrefetch(async () => {
			try {
				const { default: r } = await import("./apexcharts.ssr.esm-fe46cd2d-CkLAj-s4.js"), n = Object.assign({}, t.options, {
...
var M = /* @__PURE__ */ oe(ae, [["render", se]]), P = defineComponent({
	...
	setup(t) {
		...
		onMounted(async () => {
			try {
				const { default: r } = await import("./apexcharts.ssr.esm-fe46cd2d-CkLAj-s4.js");
