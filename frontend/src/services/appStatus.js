...
export async function checkAppStatus() {
  try {
    ...
    return {
      ...
      mark_admin_attendance_enabled: data.mark_admin_attendance_enabled,
      admin_attendance_qr_enabled: data.admin_attendance_qr_enabled,
      admin_attendance_voice_search_enabled: data.admin_attendance_voice_search_enabled,
      admin_attendance_intelligent_filtering_enabled: data.admin_attendance_intelligent_filtering_enabled,
