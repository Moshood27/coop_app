...
trait SafeInteractsWithPageTable
{
    ...
    protected HasTable $tablePageInstance;
    ...
    {
        if (isset($this->tablePageInstance)) {
            return $this->tablePageInstance;
        }
        ...
        return $this->tablePageInstance = $page;
    }
