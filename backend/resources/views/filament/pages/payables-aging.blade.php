...
<x-filament::page>
    <div class="space-y-6">
        ...
        <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm overflow-hidden">
            <div class="px-5 py-3 text-sm font-semibold text-gray-700 dark:text-gray-100 bg-gray-50 dark:bg-gray-800/60">Payables Aging (as of {{ $r['as_of'] ?? '' }})</div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                    ...
                    <tfoot class="bg-gray-50 dark:bg-gray-800/60">
                        <tr>
                            <th class="px-5 py-3 text-left text-sm font-semibold text-gray-900 dark:text-gray-100">Open Bills</th>
